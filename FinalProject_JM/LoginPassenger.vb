Public Class frmLoginPassenger
    ...
    Private Sub User_Login(ByVal strUsername As String, ByVal strPassword As String)
        Try
            Dim cmdPassengerLogin As New OleDb.OleDbCommand()
            ...
            cmdPassengerLogin.CommandText = "uspPassengerLogin"
            cmdPassengerLogin.CommandType = CommandType.StoredProcedure
            cmdPassengerLogin.Connection = m_conAdministrator

            cmdPassengerLogin.Parameters.Add(New OleDb.OleDbParameter("@LoginID", OleDb.OleDbType.VarChar)).Value = strUsername
            cmdPassengerLogin.Parameters.Add(New OleDb.OleDbParameter("@Password", OleDb.OleDbType.VarChar)).Value = strPassword

            drSourceTable = cmdPassengerLogin.ExecuteReader()
            Using drSourceTable
