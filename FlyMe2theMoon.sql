...
(
	...
	,intFKEmployeeID		INTEGER			NOT NULL
...
VALUES				  (1, 'Knelly', 'Nervious', '321 Elm St.', 'Cincinnati', 1, '45201', '5135553333', 'nnelly@gmail.com', 'Passenger1', 'Passenger1Password', '1/1/1991')
					 ,(2, 'Orville', 'Waite', '987 Oak St.', 'Cleveland', 1, '45218', '5135556333', 'owright@gmail.com', 'Passenger2', 'Passenger2Password', '2/2/1992')
					 ,(3, 'Eileen', 'Awnewe', '1569 Windisch Rd.', 'Dayton', 1, '45069', '5135555333', 'eonewe1@yahoo.com', 'Passenger3', 'Passenger3Password', '3/3/1993')
					 ,(4, 'Bob', 'Eninocean', '44561 Oak Ave.', 'Florence', 2, '45246', '8596663333', 'bobenocean@gmail.com', 'Passenger4', 'Passenger4Password', '4/4/1994')
					 ,(5, 'Ware', 'Hyjeked', '44881 Pine Ave.', 'Aurora', 3, '45546', '2825553333', 'Hyjekedohmy@gmail.com', 'Passenger5', 'Passenger5Password', '5/5/1995')
					 ,(6, 'Kay', 'Oss', '4484 Bushfield Ave.', 'Lawrenceburg', 3, '45546', '2825553333', 'wehavekayoss@gmail.com', 'Passenger6', 'Passenger6Password', '6/6/1996')
...
VALUES				  (1, '4/1/2022', '111', '10:00:00', '12:00:00', 1, 2, 1200, 2)
					 ...
					 ,(11, '01/01/2024', '256', '09:00:00', '15:00:00', 2, 5, 1300, 1)
					 ,(12, '02/02/2024', '389', '15:00:00', '20:00:00', 6, 2, 1200, 2)
					 ,(13, '03/03/2024', '456', '07:00:00', '13:00:00', 4, 1, 1500, 6)
					 ,(14, '04/04/2024', '789', '10:00:00', '21:00:00', 1, 3, 2000, 4)
...
INSERT INTO TFlightPassengers ( intFlightPassengerID, intFlightID, intPassengerID, strSeat, intCost)
VALUES				 ( 1, 1, 1, '1A', '500')
					,( 2, 1, 2, '2A', '600' )
					,( 3, 1, 3, '1B', '700' )
					,( 4, 1, 4, '1C', '800' )
...
INSERT INTO TEmployees (intEmployeeID, strEmployeeLoginID, strEmployeePassword, strEmployeeRole, intFKEmployeeID)
VALUES					(1, 'TipS', 'tipspassword', 'Co-Pilot', 1)
						,(2, 'ImaS', 'imaspassword', 'Co-Pilot', 2)
						,(3, 'HughE', 'hughepassword', 'Pilot', 3)
						,(4, 'IwannaK', 'iwannak', 'Co-Pilot', 4)
						,(5, 'RoseE', 'roseepassword', 'Pilot', 5)
						,(6, 'MillerT', 'millertpassword', 'Attendant', 1)
						,(7, 'SherleyU', 'sherleyu', 'Attendant', 2)
						,(8, 'BuhhB', 'buhhbpassword', 'Attendant', 3)
						,(9, 'MylesA', 'mylesapassword', 'Attendant', 4)
						,(10, 'WalkerT', 'walkert', 'Attendant', 5)
						,(11, 'Admin', 'Admin1', 'Admin', 0)
